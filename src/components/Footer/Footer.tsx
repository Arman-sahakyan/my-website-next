...
function Footer() {
    ...
    <div className="footer_container container">
        <div className="logo">
            ...
            <h3>Oregon Trucking Permit</h3>
        </div>
        <div className="footer_contact">
            <a href="tel:+15034387888" className="phone  contact_item">
            ...
            <a href="mailto:oregontruckingpermitinfo@gmail.com" className="email contact_item">
            ...
            <a className="contact_item" href="/privacy">Privacy Policy</a>
            <a className="contact_item" href="/terms">Terms and Conditions</a>
        </div>
